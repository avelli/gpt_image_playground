...
export default function Header({ onOpenAssetLibrary }: HeaderProps) {
          ...
          <div className="flex items-start gap-1">
            ...
            {hasUpdate && latestRelease && (
              <button
                type="button"
                onClick={dismiss}
                className="px-1.5 py-0.5 mt-0.5 rounded border border-red-500/30 text-[10px] font-bold bg-red-500 text-white transition-colors animate-fade-in leading-none"
